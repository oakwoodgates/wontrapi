 ...
 * @since 0.3.0
 */
function _manually_load_wontrapi_plugin() {
	...
	// Require our plugin.
	require dirname( dirname( __FILE__ ) ) . '/wontrapi.php';
}

// Inject in our plugin.
tests_add_filter( 'muplugins_loaded', '_manually_load_wontrapi_plugin' );
